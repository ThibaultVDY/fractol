...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/02/26 19:56:24 by tle-monn          #+#    #+#             */
/*   Updated: 2024/02/26 20:16:01 by tle-monn         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	events_init(t_fractol *fract)
{
	...
	mlx_hook(fract->window, DestroyNotify, StructureNotifyMask, clean_exit, fract);
}
